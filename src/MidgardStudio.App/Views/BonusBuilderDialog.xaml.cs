...
public partial class BonusBuilderDialog : FluentWindow
{
    ...
    /// <param name="renewal">False on a Pre-Renewal profile — hides the renewal-only (4th-job) effects so
    /// they can't be generated by mistake. The caller passes the active mode (reliable; no DI lookup).</param>
    public BonusBuilderDialog(bool renewal = true)
    {
        InitializeComponent();
        ...
        _vm = new BonusBuilderViewModel(skills, renewal);
        DataContext = _vm;
